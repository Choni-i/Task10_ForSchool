package ru.vsu.cs.parshina.util;
...
public class JTableUtils {
    ...
    public static void renameJTableColumn(JTable table) {
        DefaultTableModel tableModel = (DefaultTableModel) table.getModel();
        tableModel.addColumn(new String[] {"Район", "Район", "Район", "Район", "Район" });
        /*tableModel.getColumn(0).setHeaderValue("Район");
        tableModel.getColumn(1).setHeaderValue("Комнаты");
        tableModel.getColumn(2).setHeaderValue("Площадь");
        tableModel.getColumn(3).setHeaderValue("Площадь кухни");
        tableModel.getColumn(4).setHeaderValue("Стоимость");*/
    }

    public static void renameJTableColumnFilter(JTable table) {
        TableColumnModel tableModel = table.getColumnModel();
        tableModel.getColumn(0).setHeaderValue("Комнаты");
        tableModel.getColumn(1).setHeaderValue("Площадь");
        tableModel.getColumn(2).setHeaderValue("Площадь кухни");
        tableModel.getColumn(3).setHeaderValue("Стоимость");
    }
}
